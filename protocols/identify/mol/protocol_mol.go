...
func (s *AddressVecBuilder) Replace(index uint, v Address) *Address {
	if uint(len(s.inner)) > index {
		a := s.inner[index]
		s.inner[index] = v
		return &a
...
func AddressVecFromSlice(slice []byte, compatible bool) (*AddressVec, error) {
	...
	if sliceLen < int(offsetFirst) {
		errMsg := strings.Join([]string{"HeaderIsBroken", "AddressVec", strconv.Itoa(int(sliceLen)), "<", strconv.Itoa(int(offsetFirst))}, " ")
		return nil, errors.New(errMsg)
	}
...
func AddressFromSlice(slice []byte, compatible bool) (*Address, error) {
	...
	if sliceLen < int(offsetFirst) {
		errMsg := strings.Join([]string{"HeaderIsBroken", "Address", strconv.Itoa(int(sliceLen)), "<", strconv.Itoa(int(offsetFirst))}, " ")
		return nil, errors.New(errMsg)
	}
...
func IdentifyMessageFromSlice(slice []byte, compatible bool) (*IdentifyMessage, error) {
	...
	if sliceLen < int(offsetFirst) {
		errMsg := strings.Join([]string{"HeaderIsBroken", "IdentifyMessage", strconv.Itoa(int(sliceLen)), "<", strconv.Itoa(int(offsetFirst))}, " ")
		return nil, errors.New(errMsg)
	}
